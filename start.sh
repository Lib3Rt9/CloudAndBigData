...
SECRET_KEY_DIR=$(realpath "$HOME/secrets")
...
(
    ...
    echo "Waiting for the machine fully functioning..."
    sleep 20
)
...
(
    ...
    echo "$HOME first"
    sudo chmod 600 $HOME/secrets/id_ed25519
    sudo chmod 644 $HOME/secrets/id_ed25519.pub
    echo "$HOME second"
    echo "$HOME/secrets/id_ed25519"
...
(
    ...
    sleep 20
    echo "Finished Spark job, waiting for clean up..."
)
